...
public class NotificationFragment extends Fragment {
    ...
    private String[] notifications = {"Notification 1", "Notification 2", "Notification 3"};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRecyclerView.setAdapter(new NotificationAdapter(this.getContext(), notifications));
        return view;
    }
}
